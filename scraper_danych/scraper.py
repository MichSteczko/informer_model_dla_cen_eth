...
class ScrapeCryptoPrice:
    ...
    def _get_unix_timestamps_from_time_period(self,
    ...
    def get_api_links(self):
        ...
        api_links = []
        unix_intervals = self._get_unix_timestamps_from_time_period(self.start_date, self.end_date)
...
elko = ScrapeCryptoPrice(date_a, date_b, "ethereum", "usd").get_api_links()
witam = save_token_historical_data(elko.get_token_prices(), "ethereum")
print(witam)
print("unix_timestamp => ", (type(time.mktime(date_b.timetuple()))))
